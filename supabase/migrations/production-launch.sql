-- ╔══════════════════════════════════════════════════════════════════════════════╗
-- ║                                                                            ║
-- ║   SVU Community — Production Launch Script                                 ║
-- ║   سكربت الإطلاق النهائي — يُنفَذ مرة واحدة على Supabase                     ║
-- ║                                                                            ║
-- ║   التاريخ: 2026-03-21                                                     ║
-- ║   الرابط: https://supabase.com/dashboard/project/_/sql                    ║
-- ║                                                                            ║
-- ╚══════════════════════════════════════════════════════════════════════════════╝
...
-- 8.2 عرض الأعمدة في كل جدول
SELECT '=== أعمدة جدول users ===' AS section;
...
-- 8.7 عرض Storage Buckets
SELECT '=== Storage Buckets ===' AS section;
SELECT id, name, public, file_size_limit
FROM storage.buckets;

-- 8.8 عرض Realtime Tables
...
--
-- 3️⃣  لتعيين أدمن — شغّل هذا الأمر بإيميلك:
--     UPDATE public.users SET is_admin = true WHERE email = 'your-email@example.com';
--     (بعد تسجيل الدخول أولاً حتى يكون صفّك موجوداً)
--
-- 4️⃣  تأكد أن ملف js/config.js يحتوي على SUPABASE_URL و SUPABASE_ANON_KEY
--
-- ═══════════════════════════════════════════════════════════════════════════════
